...
from models.binarized_modules import BinarizeConv2d, BinarizeAct
...
def conv1x1(in_planes, out_planes, stride=1, bit=32):
    """1x1 convolution"""
    return nn.Conv2d(in_planes, out_planes, kernel_size=1, stride=stride, bias=False, bit=bit)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.relu1 = BinarizeAct(inplace=True, bit=bit)
        
        self.conv2 = conv3x3(planes, planes, bit=bit)
        self.bn2 = norm_layer(planes)
        self.relu2 = BinarizeAct(inplace=True, bit=bit)
