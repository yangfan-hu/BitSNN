...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, rho=0.3):
...
def resnet20_1w1a(num_classes=10, rho=0.3):
    return ResNet(BasicBlock_1w1a, [3, 3, 3],num_classes=num_classes, rho=rho)
